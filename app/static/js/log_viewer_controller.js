...
(function(){
  ...
  function populateModuleOptions(items){
    ...
    // Standard-Module die immer verfügbar sein sollten
    const standardModules = ['app', 'services', 'database', 'mqtt', 'bambu', 'errors'];
    const mods = new Set(standardModules);
    
    // Zusätzliche Module aus den Logs extrahieren
    (items||[]).forEach(it => {
