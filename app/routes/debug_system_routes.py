...
try:
    ...
    logger.exception("Failed to import MQTT runtime state; using fallback defaults")
...
def system_status(request: Request):
    ...
    try:
        if mqtt_clients:
            ...
            try:
                ...
                logger.exception("MQTT connection_id parsing failed")
                host, port = None, None
            ...
            try:
                ...
                logger.exception("MQTT connection status check failed")
        ...
        logger.exception("MQTT state evaluation failed")
    ...
    try:
        ...
        logger.exception("WebSocket state evaluation failed")
        websocket_state = {"state": "offline"}
    ...
    try:
        ...
        logger.exception("WebSocket state aggregation failed")
        websocket_state = {"state": "offline"}
    ...
    try:
        ...
        logger.exception("Runtime metrics normalization failed")
    ...
    def _load_health_thresholds():
        ...
        try:
            ...
            logger.exception("System health threshold load failed; using defaults")
    ...
    try:
        ...
        logger.exception("System health evaluation failed")
        health_status = "warning"
        if not reasons:
