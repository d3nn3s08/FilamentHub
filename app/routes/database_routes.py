...
@router.get("/tables")
def get_table_info(_: None = Depends(admin_required)):
...
@router.get("/query")
def execute_query(sql: str, _: None = Depends(admin_required)):
...
@router.post("/editor")
def execute_editor_query(payload: SQLEditorRequest, _: None = Depends(admin_required)):
...
@router.post("/vacuum")
def vacuum_database(_: None = Depends(admin_required)):
...
@router.post("/migrate")
def migrate_database(_: None = Depends(admin_required)):
...
@router.delete("/row")
def delete_row(table: str, id: str, _: None = Depends(admin_required)):
