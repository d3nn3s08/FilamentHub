...
class MaterialBase(SQLModel):
    ...
    is_bambu: Optional[bool] = None
    spool_weight_full: Optional[float] = None
    spool_weight_empty: Optional[float] = None  # Leergewicht der Spule (Hersteller-spezifisch)
...
class MaterialCreateSchema(BaseModel):
    ...
    is_bambu: bool | None = None
    spool_weight_full: float | None = None
    spool_weight_empty: float | None = None
    notes: str | None = None
