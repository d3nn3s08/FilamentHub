...
# This script was an ad-hoc test script moved out of tests/.
# It is not a pytest test; keep for manual/debug use only.
...
try:
    ...
    print(f"Warnung: DB-Datei {DB_PATH} ist gelockt, verwende bestehende Datei.")
