...
function handleNotificationIdChange() {
    const selectedId = document.getElementById("notif-id").value;
    if (!selectedId) return;

    const notification = notificationsConfig.find(n => n.id === selectedId);
    if (notification) {
